...
% Types
morekeywords=[2]{expr, name, level, list, binder_info, bool, nat, macro_def,
Sort*, Sort, Type, Prop, Type*, Type₀, Type₁, Type₂, Type₃},
...
% Style for sorts
keywordstyle=[2]{\ttfamily\color{typecolor}},

% Style for meta constants
