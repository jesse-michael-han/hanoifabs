...
\begin{frame}[fragile]{Tactic State}
  \begin{tikzpicture}
    \fill[blue!50!white] (-5, 0) rectangle (5, 8) ;
    \node at (-5, 7.7) [right] { \textbf{Tactic State} };

    \fill[orange] (-1.9, 7.5) rectangle (4.8, 1.5) ;
    \node at (-1.9, 7.2) [right] {Metavariables} ;

    \fill[orange] (-4.9, 7.5) rectangle (-2.1, 1.5) ;
    \node at (-4.9, 7.2) [right] {Environment} ;

    \fill[orange] (-4.9, 1.3) rectangle (-2.1, 0.1) ;
    \node at (-4.9, 1) [right] {Options} ;

    \fill[orange] (-1.9, 1.3) rectangle (1.8, 0.1) ;
    \node at (-1.9, 1) [right] {Goals} ;

    \fill[orange] (2, 1.3) rectangle (4.8, 0.1) ;
    \node at (2, 1) [right] {Main Goal} ;
